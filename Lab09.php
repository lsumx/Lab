    ...
    <main class="container">
		...
		<ul class="caption-style-2">
          ...
          foreach ($images as $image) {
              $content .= '<li><a href="detail.php?id=' .$image['id'] . '" class ="img-responsive"><img src="images/square/'.$image['path'].'" alt="'.$image['title']. '"><div class="caption"><div class="blur"></div><div class="caption-text"><h1>'.$image['title'].'</h1></div></div></a></li>';
